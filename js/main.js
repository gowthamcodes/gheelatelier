(function () {
  ...
  $(document).on("click", function (e) {
    ...
    $(".mry-menu , .mry-menu-btn-frame , .mry-menu-btn").removeClass(
      "mry-active"
    );
  });
  ...
  if ($("div").is("#map-dark")) {
    ...
    var map = new mapboxgl.Map({
      ...
      center: [78.69159, 10.75523],
      zoom: 11,
    });

    var marker = new mapboxgl.Marker()
      .setLngLat([78.69159, 10.75523])
      .addTo(map);
  }
